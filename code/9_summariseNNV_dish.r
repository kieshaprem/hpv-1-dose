...
for(index in 1:11)
{
  load(paste0('output/nnv_',MODELNAME[index],'.rdata'))
  nnv[[MODELNAME[index]]]  = no_to_vaccinate 
  rm(no_to_vaccinate)
  load(paste0('output/nnv_dish_',MODELNAME[index],'.rdata'))
...
save(nnvdishA,file = 'output/nnvdishA.rdata')
save(nnvdishB,file = 'output/nnvdishB.rdata')
save(nnvdishC,file = 'output/nnvdishC.rdata')
save(nnvdishD,file = 'output/nnvdishD.rdata')
save(nnvdishE,file = 'output/nnvdishE.rdata')
save(nnvdishF,file = 'output/nnvdishF.rdata')
