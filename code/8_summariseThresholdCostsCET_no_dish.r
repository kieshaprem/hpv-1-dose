...
save(thresholdAcet,file = 'output/costs/thresholdAcet_disc.rdata')
save(thresholdBcet,file = 'output/costs/thresholdBcet_disc.rdata')
save(thresholdCcet,file = 'output/costs/thresholdCcet_disc.rdata')
save(thresholdDcet,file = 'output/costs/thresholdDcet_disc.rdata')
save(thresholdEcet,file = 'output/costs/thresholdEcet_disc.rdata')
save(thresholdFcet,file = 'output/costs/thresholdFcet_disc.rdata')
