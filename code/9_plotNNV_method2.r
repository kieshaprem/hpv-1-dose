...
load('output/nnvA_M2.rdata')
load('output/nnvB_M2.rdata')
load('output/nnvC_M2.rdata')
load('output/nnvD_M2.rdata')
load('output/nnvE_M2.rdata')
load('output/nnvF_M2.rdata')

load('output/nnvdishA_M2.rdata')
load('output/nnvdishB_M2.rdata')
load('output/nnvdishC_M2.rdata')
load('output/nnvdishD_M2.rdata')
load('output/nnvdishE_M2.rdata')
load('output/nnvdishF_M2.rdata')
...
png('output/plots/fig_nnv_method2.png',width = 20,height = 23.5,units = 'cm',res = 700)
if(1)
{
  grid.newpage()
  ...
  for (REG in 1:4) 
  {
    ...
    for(model in 1:11) 
    {
      if(model<12) grid.lines(x=0.6+0.085*(model-1),y=log10(c(nnvA[[model]][3,REG],nnvA[[model]][4,REG])),default.units = 'native',gp=gpar(col=COLS[model]))
      grid.points(x=0.6+0.085*(model-1),y=log10(c(nnvA[[model]][1,REG])),default.units = 'native',pch=16,gp=gpar(col=COLS[model],cex=0.3))
      
      if(model<12) grid.lines(x=1.6+0.085*(model-1),y=log10(c(nnvB[[model]][3,REG],nnvB[[model]][4,REG])),default.units = 'native',gp=gpar(col=COLS[model]))
      grid.points(x=1.6+0.085*(model-1),y=log10(c(nnvB[[model]][1,REG])),default.units = 'native',pch=16,gp=gpar(col=COLS[model],cex=0.3))
      
      if(model<12) grid.lines(x=2.6+0.085*(model-1),y=log10(c(nnvC[[model]][3,REG],ifelse(nnvC[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvC[[model]][4,REG]))),
      ...
      # if(nnvC[[model]][4,REG]>YMAX[[REG]]) 
      if(model<12) grid.lines(x=3.6+0.085*(model-1),y=log10(c(nnvD[[model]][3,REG],ifelse(nnvD[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvD[[model]][4,REG]))),
                              default.units = 'native',gp=gpar(col=COLS[model]))
      grid.points(x=3.6+0.085*(model-1),y=log10(c(nnvD[[model]][1,REG])),default.units = 'native',pch=16,gp=gpar(col=COLS[model],cex=0.3))
      
      if(model<12) grid.lines(x=4.6+0.085*(model-1),y=log10(c(nnvE[[model]][3,REG],ifelse(nnvE[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvE[[model]][4,REG]))),
                              default.units = 'native',gp=gpar(col=COLS[model]))
      grid.points(x=4.6+0.085*(model-1),y=log10(c(nnvE[[model]][1,REG])),default.units = 'native',pch=16,gp=gpar(col=COLS[model],cex=0.3))
      # if(nnvC[[model]][4,REG]>YMAX[[REG]]) 
      if(model<12) grid.lines(x=5.6+0.085*(model-1),y=log10(c(nnvF[[model]][3,REG],ifelse(nnvF[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvF[[model]][4,REG]))),
                              default.units = 'native',gp=gpar(col=COLS[model]))
  ...
  for (REG in 1:4) 
  {
    ...
    for(model in 1:11) 
    {
      if(model<12) grid.lines(x=0.6+0.085*(model-1),y=log10(c(nnvdishA[[model]][3,REG],nnvdishA[[model]][4,REG])),default.units = 'native',gp=gpar(col=COLS[model]))
      ...
      if(model<12) grid.lines(x=1.6+0.085*(model-1),y=log10(c(nnvdishB[[model]][3,REG],nnvdishB[[model]][4,REG])),default.units = 'native',gp=gpar(col=COLS[model]))
      ...
      if(model<12) grid.lines(x=2.6+0.085*(model-1),y=log10(c(nnvdishC[[model]][3,REG],ifelse(nnvdishC[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvdishC[[model]][4,REG]))),
                              default.units = 'native',gp=gpar(col=COLS[model]))
      ...
      if(model<12) grid.lines(x=3.6+0.085*(model-1),y=log10(c(nnvdishD[[model]][3,REG],ifelse(nnvdishD[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvdishD[[model]][4,REG]))),
                              default.units = 'native',gp=gpar(col=COLS[model]))
      ...
      if(model<12) grid.lines(x=4.6+0.085*(model-1),y=log10(c(nnvdishE[[model]][3,REG],ifelse(nnvdishE[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvdishE[[model]][4,REG]))),
                              default.units = 'native',gp=gpar(col=COLS[model]))
      ...
      # if(nnvdishC[[model]][4,REG]>YMAX[[REG]]) 
      if(model<12) grid.lines(x=5.6+0.085*(model-1),y=log10(c(nnvdishF[[model]][3,REG],ifelse(nnvdishF[[model]][4,REG]>YMAX[[REG]],YMAX[[REG]],nnvdishF[[model]][4,REG]))),
                              default.units = 'native',gp=gpar(col=COLS[model]))
