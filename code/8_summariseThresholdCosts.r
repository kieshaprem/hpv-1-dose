...
save(thresholdA,file = 'output/costs/thresholdA.rdata')
save(thresholdB,file = 'output/costs/thresholdB.rdata')
save(thresholdC,file = 'output/costs/thresholdC.rdata')
save(thresholdD,file = 'output/costs/thresholdD.rdata')
save(thresholdE,file = 'output/costs/thresholdE.rdata')
save(thresholdF,file = 'output/costs/thresholdF.rdata')
