...
YMAX = list(10E6,10E6,10E5,15E6)
YAXIS = list(seq(0,10E6,2E6),
             seq(0,10E6,2E6),
             seq(0,10E5,2E5),
             seq(0,15E6,5E6))
...
png('output/plots/fig_canceraverted_cumulative_dish.png',width = 20,height = 23.5,units = 'cm',res = 700)
if(1)
{
  grid.newpage()
  ...
  for (REG in 1:4) 
  {
    ...
    for(model in 1:11) 
    {
      ...
      grid.lines(x=xvals,y=cumsum(yvals),default.units = 'native',gp = gpar(lwd=1,col=COLS[model],lty = LTY[model]))
    }
...
YMAX = list(10E7,10E7,10E6,15E7)
YAXIS = list(seq(0,10E7,2E7),
             seq(0,10E7,2E7),
             seq(0,10E6,2E6),
             seq(0,15E7,5E7))
...
png('output/plots/fig_canceraverted_cumulative.png',width = 20,height = 23.5,units = 'cm',res = 700)
if(1)
{
  grid.newpage()
  pushViewport(plotViewport(c(1,3,3,0)))
