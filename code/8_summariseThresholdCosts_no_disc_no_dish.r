...
save(thresholdA,file = 'output/costs/thresholdA_undis.rdata')
save(thresholdB,file = 'output/costs/thresholdB_undis.rdata')
save(thresholdC,file = 'output/costs/thresholdC_undis.rdata')
save(thresholdD,file = 'output/costs/thresholdD_undis.rdata')
save(thresholdE,file = 'output/costs/thresholdE_undis.rdata')
save(thresholdF,file = 'output/costs/thresholdF_undis.rdata')
