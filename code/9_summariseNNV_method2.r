...
save(nnvA,file = 'output/nnvA_M2.rdata')
save(nnvB,file = 'output/nnvB_M2.rdata')
save(nnvC,file = 'output/nnvC_M2.rdata')
save(nnvD,file = 'output/nnvD_M2.rdata')
save(nnvE,file = 'output/nnvE_M2.rdata')
save(nnvF,file = 'output/nnvF_M2.rdata')
