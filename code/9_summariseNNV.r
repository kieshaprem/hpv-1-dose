...
save(nnvA,file = 'output/nnvA.rdata')
save(nnvB,file = 'output/nnvB.rdata')
save(nnvC,file = 'output/nnvC.rdata')
save(nnvD,file = 'output/nnvD.rdata')
save(nnvE,file = 'output/nnvE.rdata')
save(nnvF,file = 'output/nnvF.rdata')
